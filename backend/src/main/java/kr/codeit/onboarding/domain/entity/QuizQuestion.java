...
/**
 * QuizQuestion entity representing a quiz question within a task.
 *
...
@Table(name = "quiz_questions", indexes = {
    @Index(name = "idx_quiz_question_task", columnList = "task_id"),
...
public class QuizQuestion extends BaseEntity {
    ...
    /**
     * List of answers submitted by instructors for this question.
     */
    ...
    /**
     * Checks if this question has been answered by any instructor.
     *
     * @return true if at least one answer exists
     */
